...
export function Message({ name, time, message, quantity, ...rest }: MessageProps) {
    return (
        <TouchableOpacity className="w-full" {...rest}>
            <View className="flex-row border border-black/10 rounded-xl p-4 gap-3 items-center shadow-md shadow-black/10">
                <View className="p-2 bg-blue-600 items-center justify-center rounded-full ">
